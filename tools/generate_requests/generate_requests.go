...
var supportedInputs = []reflect.Type{
	...
	reflect.TypeFor[dynamodb.TransactGetItemsInput](),
}
...
func run(outPath string) error {
	...
	for _, name := range gen.order {
		body.WriteString(gen.decls[name])
		body.WriteString("\n\n")
	}

	var buf bytes.Buffer
	buf.WriteString("// Code generated by tools/generate_requests; DO NOT EDIT.\n\n")
	buf.WriteString("// Package server exposes request shapes mirrored from DynamoDB inputs.\n")
	buf.WriteString("package server\n\n")
	buf.WriteString("import (\n")

	if strings.Contains(body.String(), "ddb.") {
